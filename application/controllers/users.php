...
class Users extends CI_Controller
{
    ...
    public function new_user()
    {
        ...
        $this->form_validation->set_rules( 'first_name', 'First Name', 'required|min_lenght[1]|max_lenght[125]' );
        $this->form_validation->set_rules( 'last_name', 'Last Name', 'required|min_lenght[1]|max_lenght[125]' );
        $this->form_validation->set_rules( 'email', 'Email', 'required|min_lenght[1]|max_lenght[255]|valid_email' );
        $this->form_validation->set_rules( 'is_active', 'Is Active', 'min_lenght[1]|max_lenght[1]|integer|is_natural' );
        ...
        {
            // Validation passed, now escape data
            $data = array(
    ...
    public function delete_user()
    {
        ...
        //set validation rules
        $this->form_validation->set_rules( 'id', 'User ID', 'required|min_lenght[1]|max_lenght[11]|integer|is_natural' );
